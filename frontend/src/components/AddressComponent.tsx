...
const AddressComponent: React.FC<AddressComponentProps> = ({
    ...
    geocoderRef.current.geocode(
      ...
      `;
        ...
        try {
          ...
          setAllStreets(streets as string[]);
        } catch (error) {
  ...
  useEffect(() => {
    if (plz && city && street && houseNumber) {
      ...
      if (plz.length > 0) errors.plz = "";
      if (city.length > 0) errors.city = "";
      if (street.length > 0) errors.street = "";
      if (houseNumber.length > 0) errors.houseNumber = "";
              ...
              {showSessionSuggestion && sessionAddress && (
                ...
                >
                  ...
                  <div className=" text-gray-800">
                    {sessionAddress.plz} {sessionAddress.city}.{" "}
                    {sessionAddress.street} {sessionAddress.houseNumber}
                  </div>
                </div>
              )}
